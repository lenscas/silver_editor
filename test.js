...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "test.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "test.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'test'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'test':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_88bbac905924de8d28070910300b0d8ac4eae4c6": function($0, $1, $2, $3, $4) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);let script_tag=document.createElement("script");script_tag.type="text/javascript";script_tag.text=($0);document.body.appendChild(script_tag);let el;if(($1)){el=document.getElementsByTagName(($2))[0]}else{el=document.getElementById(($3))}window.silver_editor.setup_extra_window_button(($4),el);
            },
            ...
            "__cargo_web_snippet_9910cee3211b191319c69cb6fe2a0d0309ba6e4d": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);window.silver_editor.send_event(JSON.parse(($0)));
            },
            ...
            "__cargo_web_snippet_efb860f6c3a047b3f8a9e3b78de914dac86ea3fe": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return silver_editor.get_events().map(v=>JSON.stringify(v));})());
            },
